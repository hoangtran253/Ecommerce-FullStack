    ...
    <Container>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Quản lý sản phẩm — tồn kho đồng bộ với{" "}
        ...
        {showEditModal && (
          ...
          >
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-auto">
              ...
              <form onSubmit={handleUpdateProduct} className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="new_arrivals">Hàng mới đến</option>
                      <option value="best_sellers">Hàng bán chạy</option>
                    </select>
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <label htmlFor="edit-hasVariants" className="text-sm text-gray-700">
            ...
            <div className="bg-white rounded-lg max-w-md w-full">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">
                  Bạn có chắc chắn muốn xóa sản phẩm này không? Thao tác này sẽ
xóa vĩnh viễn sản phẩm này khỏi kho hàng của bạn.
                </p>
