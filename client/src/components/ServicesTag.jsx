...
const services = [
  {
    ...
    subtitle: "Miễn phí vận chuyển cho đơn hàng từ 500.000đ trở lên",
    icon: <TbTruckDelivery />,
    details: {
      description:
        "Tận hưởng dịch vụ giao hàng tiêu chuẩn miễn phí cho mọi đơn hàng có giá trị từ 500.000đ trở lên. Chúng tôi hợp tác với các đơn vị vận chuyển uy tín để đảm bảo sản phẩm đến tay bạn an toàn và đúng hẹn.",
      features: [
        "Miễn phí vận chuyển cho đơn từ 500000đ",
